...
"""autogenerated by genpy from my_robot_msgs/OdometryActionResult.msg. Do not edit."""
import codecs
import sys
...
class OdometryActionResult(genpy.Message):
  _md5sum = "88c4dd86448d5370be05c4d5e1ee0701"
  _type = "my_robot_msgs/OdometryActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_robot_msgs/OdometryResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(OdometryActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = my_robot_msgs.msg.OdometryResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_robot_msgs.msg.OdometryResult()
