...
let CountUtilGoal = require('./CountUtilGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class CountUtilActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CountUtilGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CountUtilActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = CountUtilGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new CountUtilGoal()
    }
...
module.exports = CountUtilActionGoal;
