...
let OdometryGoal = require('./OdometryGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class OdometryActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = OdometryGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new OdometryActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = OdometryGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new OdometryGoal()
    }
...
module.exports = OdometryActionGoal;
